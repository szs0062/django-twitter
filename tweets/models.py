...
class Tweet(models.Model):
    ...
    # 新增的field一定要设置 null=True， 否则default = 0会遍历整个表单去设置
...
class TweetPhoto(models.Model):
    ...
    # 谁上传了这张图片，这个信息虽然可以从tweet中取到，但是重复的记录在Image里可以在
    # 使用上带来很多便利，比如某个人经常上传一些不合法的照片，那么这个人新上传的照片可以
    # 被标记成重点审查对象，或者我们需要禁封某个用户上传的所有照片的时候，就可以通过这个
    # model 快速进行筛选
    ...
    # 才会被真正的删除。这样做的目的是，如果在tweet被删除的时候马上执行真删除通常会花费一定的
